-- פתרון סופי מעודכן לבעיית אתחול טבלאות פרויקט
-- מבוסס על המבנה המדויק של כל הטבלאות
...
-- פונקציה להעתקת שלבים לטבלת פרויקט - מותאמת למבנה הנכון של השלבים
-- מכיוון שאנו בונים את טבלת השלבים בהתאם למשימות שנבחרו, פונקציה זו
-- תעבור בצורה חכמה על המשימות ותייצר את השלבים המתאימים
DROP FUNCTION IF EXISTS build_stages_from_selected_tasks(uuid);
...
-- פונקציה לאתחול טבלאות הפרויקט עם טיפול בשגיאות - המתאימה לתהליך שתיארת
